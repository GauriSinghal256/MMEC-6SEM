  ...
  return (
    <div className="min-h-screen flex bg-[#0A0A0A] page-enter">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="relative flex-shrink-0">
                  <img
                    ...
                    className="w-10 h-10 rounded-full ring-2 ring-violet-800/40 ring-offset-1 ring-offset-[#111] object-cover"
                  />
                  ...
                  <div className="flex justify-between items-center mt-3">
                    ...
                    <div className="flex gap-1">
                      {['📷','🎬','📅','😊'].map(e => (
                        <button
                          key={e}
                          className="text-lg p-1.5 rounded-lg hover:bg-white/[0.05] transition-all hover:scale-110 active:scale-95"
                        >
                          {e}
                        </button>
                      ))}
            ...
            <div className="card animate-slide-right stagger-2 p-5">
              ...
              <div className="space-y-0.5">
                {trends.map(t => (
                  <div
                    key={t.tag}
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-white/[0.05] cursor-pointer group transition-all duration-150 active:scale-[0.98]"
                  >
                    <Hash size={11} className="text-[#4B5563] group-hover:text-violet-400 transition-colors flex-shrink-0" />
                    <span className="text-sm text-[#9CA3AF] group-hover:text-violet-400 transition-colors font-medium flex-1">
                      {t.tag}
                    </span>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  ...
                  {[
                    ...
                    <button
                      key={label}
                      className="w-full text-left px-3 py-2.5 rounded-xl border border-[#111]/[0.08] hover:bg-white/[0.06] hover:border-violet-700/40 transition-all duration-200 group active:scale-[0.98]"
                    >

                      <div className="flex items-center gap-2.5">

                        <span className="text-base group-hover:scale-110 transition-transform duration-200 inline-block">
                          {emoji}
                        </span>

                        <div>
                          <p className="text-xs font-semibold text-[#E5E7EB] leading-tight">
                            {label}
                          </p>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[9999] w-12 h-12 flex items-center justify-center rounded-full btn-gold shadow-xl hover:scale-110 transition"
      >
        <PenLine size={18} />
      </button>
